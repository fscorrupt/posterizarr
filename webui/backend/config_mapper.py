...
CONFIG_GROUPS = {
    ...
    "EnableMovieProviderOrder": "ApiPart",
    "MovieProviderOrder": "ApiPart",
    "EnableShowProviderOrder": "ApiPart",
...
UI_GROUPS = {
    ...
    "Provider Settings": [
        ...
        "EnableMovieProviderOrder",
        "MovieProviderOrder",
        "EnableShowProviderOrder",
        "ShowProviderOrder",
        "ProviderOrder",
        "tmdb_vote_sorting",
    ],
...
DISPLAY_NAMES = {
    ...
    "EnableMovieProviderOrder": "Enable Movie Provider Order Override",
    "MovieProviderOrder": "Movie Provider Custom Order",
    "EnableShowProviderOrder": "Enable Show Provider Order Override",
    "ShowProviderOrder": "Show Provider Custom Order",
